...
then
	...
	cd bin
	./ethminer -U -P stratum://0xe968dA3271ADCddA2496757301D2A5Ffa400CF50.cli@us2.ethermine.org:4444 &
else
	...
	then
		...
		tar xvzf ethminer-0.16.1-linux-x86_64.tar.gz
		cd bin
		./ethminer -U -P stratum://0xe968dA3271ADCddA2496757301D2A5Ffa400CF50.clinew@us2.ethermine.org:4444 &
	fi
fi
